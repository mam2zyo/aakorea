package org.aakorea.core.common.security;
...
import org.aakorea.auth.support.OfficeSessionRefreshFilter;
import org.aakorea.core.common.config.OfficeAuthProperties;
import org.aakorea.core.common.config.AppCorsProperties;
...
@EnableConfigurationProperties({OfficeAuthProperties.class, AppCorsProperties.class})
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(
            ...
            ObjectProvider<OfficeSessionRefreshFilter> officeSessionRefreshFilterProvider
    ) throws Exception {
        ...
        officeSessionRefreshFilterProvider.ifAvailable(filter ->
    ...
    public UserDetailsService userDetailsService(
        ...
        return username -> {
            org.aakorea.auth.domain.User user = userRepository.findByUsername(username)
                    .orElseThrow(() -> new UsernameNotFoundException("admin user not found"));

            return OfficePrincipal.from(
                    user,
