package org.aakorea.core.common.audit.api.office;
...
import org.aakorea.core.common.audit.DomainChangeLog;
import org.aakorea.core.common.audit.DomainChangeLogRepository;
...
@RestController
@RequestMapping("/api/office/audit-logs")
@RequiredArgsConstructor
public class AuditLogOfficeController {
    ...
    public ApiResponse<Page<AuditLogData>> getAuditLogs(
        ...
        Map<Long, String> userEmailMap = userRepository.findAllByIdIn(userIds).stream()
