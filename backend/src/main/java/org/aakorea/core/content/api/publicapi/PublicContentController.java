package org.aakorea.core.content.api.publicapi;

import java.util.List;
import lombok.RequiredArgsConstructor;
import org.aakorea.core.common.response.ApiResponse;
import org.aakorea.core.content.application.PublicContentQueryService;
...
public class PublicContentController {
    ...
    public ApiResponse<PublicContentQueryService.PublicContentPageData> getContentPage(@PathVariable String key) {
        return ApiResponse.success(publicContentQueryService.getContentPage(key));
    }
