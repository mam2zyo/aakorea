...
import org.aakorea.main.organization.api.admin.OrganizationAdminController;
...
@WebMvcTest(controllers = {AuthController.class, OrganizationAdminController.class})
@Import({
        AuthService.class,
...
class AuthAndOrganizationApiTest {
    ...
    void loginCreatesSessionAndAllowsAccessToAdminApi() throws Exception {
        given(organizationAdminService.getDistricts())
                .willReturn(java.util.List.of(new OrganizationAdminService.DistrictData(1L, "서울", true)));
    ...
    void createDistrictReturnsCreatedResponse() throws Exception {
        given(organizationAdminService.createDistrict("서울", true))
                .willReturn(new OrganizationAdminService.DistrictData(1L, "서울", true));
