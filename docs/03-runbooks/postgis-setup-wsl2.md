# PostGIS Setup Guide for WSL2 (Ubuntu 24.04)

이 문서는 개발 환경(WSL2)에서 위치 기반 검색 성능 향상을 위해 PostGIS를 설치하고 설정하는 과정을 설명합니다.
...
## 2. PostGIS 패키지 설치
WSL2 터미널에서 아래 명령어를 실행하여 PostGIS 패키지를 설치합니다.
