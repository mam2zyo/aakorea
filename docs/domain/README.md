...
### 4. API 세부 형식은 Swagger UI를 참고한다

도메인 문서에서는 API 이름 정도만 언급하고, 구체적인 요청/응답 JSON 규격은 Swagger UI(`http://localhost:5173/swagger-ui/index.html` 혹은 운영 서버의 `/swagger-ui/index.html`)에서 확인하도록 유도하며 이 디렉토리 내에 중복해서 기록하지 않습니다.
