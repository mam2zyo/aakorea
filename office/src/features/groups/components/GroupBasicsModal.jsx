        ...
        <div className="office-group-modal__body">
          ...
          >
            <div className="office-group-edit-sheet__rowline">
              <label className="office-group-edit-sheet__rowlabel" htmlFor="group-modal-name">
                그룹 이름
              </label>
            ...
            <div className="office-group-edit-sheet__rowline">
              <label className="office-group-edit-sheet__rowlabel" htmlFor="group-modal-district">
                지역연합
              </label>
              <div className="office-group-edit-sheet__rowcontrol office-group-edit-sheet__rowcontrol--compact">
                <select
            ...
            <div className="office-group-edit-sheet__rowline">
              <label className="office-group-edit-sheet__rowlabel" htmlFor="group-modal-notice">
                그룹 공지
              </label>
