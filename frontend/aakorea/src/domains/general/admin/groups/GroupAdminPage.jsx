...
import ServiceAdminPage from '../layout/ServiceAdminPage'
import { fetchAdminDistricts } from '../districts/api'
import { createAdminGsr, deleteAdminGsr, fetchAdminGsrs, updateAdminGsr } from '../gsrs/api'
import {
...
import { DAY_OF_WEEKS, MEETING_STATUSES, MEETING_TYPES, NOTICE_TYPES, PROVINCES } from '../../../../shared/lib/aa-reference'
...
export default function AdminGroupPage() {
  ...
  return (
    <ServiceAdminPage
      title="그룹 관리"
      description="그룹 정보, 그룹 연락처, GSR 관리, 그리고 그룹 정기 모임까지 service 운영 메뉴 안에서 관리합니다."
    >
