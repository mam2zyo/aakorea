const overviewCards = [
  ...
  },
  {
    title: "주소록",
    description:
      "배송지 마스터는 user 도메인에 남기고, 주문/구독은 각 도메인이 스냅샷으로 보존하는 구조를 전제로 합니다.",
  },
  {
    title: "주문/구독 요약",
    description:
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <h2 className="text-xl font-semibold text-slate-900">내 공간 구조</h2>
        <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">
          현재는 공통 사용자 영역을 위한 프론트 구조만 먼저 분리했습니다. 실제
