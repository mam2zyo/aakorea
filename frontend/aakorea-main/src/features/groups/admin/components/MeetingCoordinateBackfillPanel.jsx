...
export function MeetingCoordinateBackfillPanel({ onError, onSuccess }) {
  ...
  return (
    <section className="editor-card admin-ops-panel" aria-label="모임 좌표 보정">
      ...
      <div className="admin-ops-panel__body">
        ...
        {backfillPreview ? (
          <div className="admin-ops-panel__summary">
            ...
            <div className="content-note">
              ...
              <div className="entity-list">
                {previewItems.map((item) => (
                  <article
                    ...
                    className="entity-item admin-ops-panel__result-item"
                  >
              ...
              {backfillPreview.items.length > BACKFILL_ITEM_LIMIT ? (
  ...
  async function previewBackfill() {
    ...
    try {
      const result = await adminMeetingApi.backfillCoordinates(true)
  ...
  async function applyBackfill() {
    ...
    try {
      const result = await adminMeetingApi.backfillCoordinates(false)
      setBackfillPreview(result)
      onSuccess(
